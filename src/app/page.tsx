...
function ROIMockup() {
  return (
    <div className="bg-[#0B1120] rounded-2xl border border-white/[0.08] p-7 shadow-2xl">
      <div className="flex items-center justify-between mb-6">
        <div className="text-[12px] font-semibold text-white/60 uppercase tracking-wider">Lönsamhet per maskin</div>
        <div className="flex items-center gap-1.5 text-emerald-400 text-[11px] font-medium bg-emerald-500/10 px-2.5 py-1 rounded-full">
      ...
      <div className="mt-6 pt-5 border-t border-white/[0.06] grid grid-cols-3 gap-3">
        {[
          ...
          <div key={label} className="text-center">
            <div className={`text-[16px] font-bold ${icon}`}>{value}</div>

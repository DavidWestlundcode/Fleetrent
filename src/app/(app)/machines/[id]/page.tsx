...
import {
  ...
  Zap, MapPin, Clock, DollarSign, BarChart2,
} from 'lucide-react';
...
export default function MachineDetailPage() {
  ...
  const { machines, orders, customers, serviceRecords } = useStore();
  ...
  // Fake monthly revenue data for chart
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  { label: 'Kapacitet', value: machine.capacity, icon: TrendingUp },

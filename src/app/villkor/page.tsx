...
export default function VillkorPage() {
  return (
    <PublicLayout title="Användarvillkor">
      ...
      <p className="mb-4">9.4 Leverantören ansvarar inte för skador, förluster eller kostnader som uppkommer till följd av kundens uthyrningsverksamhet, inklusive men inte begränsat till stöld, förlust av utrustning, sakskador, personskador, driftstopp, felaktig användning av maskiner eller tvister mellan kunden och dess kunder, leverantörer eller samarbetspartners.</p>
      <p className="mb-4">9.5 FleetOS tillhandahålls i befintligt skick ("as is"). Leverantören lämnar inga uttryckliga eller underförstådda garantier avseende tjänstens funktion, tillgänglighet, lämplighet för visst ändamål eller att tjänsten kommer att vara fri från fel, avbrott eller störningar.</p>
      <p className="mb-4">9.6 Leverantören garanterar inte oavbruten eller felfri drift. Tillfälliga avbrott kan förekomma till följd av underhåll, uppdateringar, säkerhetsåtgärder, tekniska problem eller omständigheter utanför Leverantörens kontroll. Kunden har inte rätt till ersättning eller skadestånd på grund av sådana avbrott, såvida inte annat uttryckligen anges i avtalet.</p>
      <p className="mb-4">9.7 Leverantören ansvarar inte för fel, avbrott eller brister som orsakas av tredjepartsleverantörer, externa integrationer, API:er, kommunikationsnät, internetanslutningar, molninfrastruktur eller andra omständigheter utanför Leverantörens rimliga kontroll.</p>
      <p className="mb-4">9.8 Leverantören ansvarar inte för felaktiga transaktioner, dokument, fakturor, avtal, rapporter eller dataöverföringar som uppstår genom användning av tredjepartsintegrationer eller på grund av felaktig, ofullständig eller föråldrad information som tillhandahållits av kunden eller tredje part.</p>
      <p className="mb-4">9.9 Om FleetOS tillhandahåller analyser, rekommendationer, prognoser, automatiserade arbetsflöden eller funktioner baserade på artificiell intelligens eller automatiserad databehandling är dessa endast vägledande. Kunden ansvarar ensam för samtliga affärsbeslut, ekonomiska beslut och operativa beslut som fattas med stöd av sådan information.</p>
      <p className="mb-4">9.10 Leverantören ansvarar inte för indirekt skada, följdskada eller ren förmögenhetsskada, inklusive men inte begränsat till utebliven vinst, uteblivna intäkter, förlust av kunder, produktionsbortfall, dataförlust, goodwillförlust, förlust av affärsmöjligheter eller andra ekonomiska följdverkningar.</p>
      <p className="mb-4">9.11 Leverantören ansvarar inte för dataförlust, datakorruption, obehörig åtkomst, säkerhetsincidenter eller dataintrång som orsakats av tredje part, kundens användare, kundens systemmiljö eller andra omständigheter utanför Leverantörens rimliga kontroll.</p>
      <p className="mb-4">9.12 Om Leverantören trots ovanstående bestämmelser skulle anses ansvarig för skada ska Leverantörens sammanlagda ansvar under en tolvmånadersperiod vara begränsat till det högre av: a) de avgifter som kunden faktiskt har betalat för FleetOS under de tolv (12) månader som närmast föregått den skadegörande händelsen, eller b) 10 000 SEK.</p>
      <p className="mb-4">9.13 Kunden ska framställa skriftligt krav mot Leverantören senast nittio (90) dagar efter att kunden upptäckt eller borde ha upptäckt den omständighet som ligger till grund för kravet. Anspråk som framställs senare ska anses förverkade.</p>

...
export default function IntegritetspolicyPage() {
  return (
    <PublicLayout title="Integritetspolicy">
      ...
      <p className="mb-4">DSE ENTERPRISE AB är personuppgiftsansvarig för behandlingen av dina personuppgifter i samband med användning av FleetRent.</p>
      ...
      <p className="mb-4">Du har rätt att begära tillgång till, rättelse av och radering av dina personuppgifter. Du har även rätt att invända mot behandlingen och att begära dataportabilitet. Kontakta oss på <a href="mailto:gdpr@fleetrent.se" className="text-blue-600 hover:underline">gdpr@fleetrent.se</a> för att utöva dina rättigheter.</p>

      <h2 className="text-lg font-semibold text-slate-900 mt-8 mb-3">6. Kontakt</h2>
      <p className="mb-4">Frågor om vår behandling av personuppgifter skickas till <a href="mailto:gdpr@fleetrent.se" className="text-blue-600 hover:underline">gdpr@fleetrent.se</a>. Du har även rätt att lämna klagomål till Integritetsskyddsmyndigheten (IMY).</p>
    </PublicLayout>
  );
}
